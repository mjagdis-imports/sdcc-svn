/*-------------------------------------------------------------------------
  port_mos6502.c - port specific file for mos6502
...
mos6502_init (void)
{
  m6502_opts.sub = SUB_MOS6502;
  asm_addTree (&asm_asxxxx_mapping);
}

static const char *
mos6502_get_model (void)
{
...
static void
mos6502_genAssemblerStart (FILE * of)
{
  fprintf(of, "\t.r6500\n");
...
PORT mos6502_port =
  {
    ...
    NULL,
    m6502_keywords,
    mos6502_genAssemblerStart,  /* genAssemblerStart */
