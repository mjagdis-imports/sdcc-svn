/*-------------------------------------------------------------------------
  port_huc6280.c - port specific file for huc6280
...
static char _huc6280_defaultRules[] =
  {
#include "peeph.rul"
  };
...
static const char * const _libs_huc6280[] = { "huc6280", NULL, };
...
PORT huc6280_port =
  {
    ...
    NULL,
    m6502_keywords,
    huc6280_genAssemblerStart,  /* genAssemblerStart */
