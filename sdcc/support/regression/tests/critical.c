...
#if defined(__SDCC_mcs51) || defined(__SDCC_z80) || defined(__SDCC_z180) || defined(__SDCC_ez80) || defined(__SDCC_r2k) || defined(__SDCC_r2ka) || defined(__SDCC_r3ka) || defined(__SDCC_r4k) || defined(__SDCC_r5k) || defined(__SDCC_r6k) || defined(__SDCC_hc08) || defined(__SDCC_s08) || defined(SDCC_MOS) || defined(__SDCC_tlcs90) || defined(__SDCC_stm8)
