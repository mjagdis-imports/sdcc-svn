# Regression test specification for the r800 target running with uCsim
...
ifndef CROSSCOMPILING
  ...
  LINKFLAGS += --nostdlib -L$(top_builddir)/device/lib/build/r800
endif
endif
