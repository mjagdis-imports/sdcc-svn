...
ifndef CROSSCOMPILING
  ...
  LINKFLAGS += --nostdlib -L$(top_builddir)/device/lib/build/mos65c02-stack-auto
endif
endif
...
SDCCFLAGS += -mmos65c02 --stack-auto -DSTACK_SIZE=256 --less-pedantic --code-loc 0x8000 --xram-loc 0x0200 --i-code-in-asm --opt-code-speed
